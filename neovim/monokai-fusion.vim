" Monokai fusion
" Brings the best of vim monokai together
"
...
let g:colors_name = "monokai-fusion-tw"

" User Options
if !exists("g:monokai_fusion_italic")
    let g:monokai_fusion_italic = 0
endif

if g:monokai_fusion_italic
...
let s:yellow = { "cterm": 228, "gui": "#FCE566" }
let s:purple = { "cterm": 141, "gui": "#AC80FF" }
let s:pale_green = { "cterm": 121, "gui": "#c1e4d3" }
let s:light_green = { "cterm": 148, "gui": "#7BD88F" }
let s:light_blue = { "cterm": 81, "gui": "#66D6ED" }
let s:magenta = { "cterm": 197, "gui": "#fc618d" }
let s:orange = { "cterm": 208, "gui": "#fd9353" }
let s:pink = { "cterm": 219, "gui": "#ff80f4" }
...
let s:darker_grey = { "cterm": 238, "gui": "#403e41" }
let s:light_charcoal = { "cterm": 238, "gui": "#3a3a3a" }
let s:charcoal = { "cterm": 16, "gui": "#2d2a2e" }

let s:danger = { "cterm": 197, "gui": "#ff005f" }
let s:olive = { "cterm": 64, "gui": "#5faa86" }
...
let s:teal = { "cterm" : 25, "gui": "#0294a5" }
...
call Highlight("CursorLineNR", s:light_grey, s:none, s:none)
...
call Highlight("Type", s:light_blue, s:none, s:italic)
...
call Highlight("Delimiter", s:white, s:none, s:none)
...
"call Highlight("Identifier", s:white, s:none, s:none)
call Highlight("Identifier", s:light_blue, s:none, s:italic)
call Highlight("Question", s:light_blue, s:none, s:none)
call Highlight("StorageClass", s:light_blue, s:none, s:italic)
call Highlight("Structure", s:light_blue, s:none, s:italic)
call Highlight("Typedef", s:light_blue, s:none, s:italic)

call Highlight("Function", s:light_green, s:none, s:none)

call Highlight("Constant", s:light_blue, s:none, s:none)
...
call Highlight("Character", s:yellow, s:none, s:none)
...
call Highlight("SpecialComment", s:sea_blue, s:none, s:italic)
call Highlight("FoldColumn", s:teal, s:light_charcoal, s:none)
...
" Vimscript
" call Highlight("vimCommand", s:pink, s:none, s:none)
...
call Highlight("jsDestructuringBlock", s:orange, s:none, s:none)  "added
...
call Highlight("jsxComponentName", s:magenta, s:none, s:none)
call Highlight("jsxEqual", s:magenta, s:none, s:none)
call Highlight("jsxPunct", s:white, s:none, s:none)
call Highlight("jsxCloseString", s:grey, s:none, s:none)
call Highlight("jsxAttrib", s:light_green, s:none, s:italic)   "added
...
call Highlight("graphqlTemplateString", s:magenta, s:none, s:none)
...
" SCSS
call Highlight("cssURL", s:orange, s:none, s:none)   "added (pro)
call Highlight("cssBraces", s:white, s:none, s:none)   "added (Function)
" assigns minus signs and em units both
call Highlight("cssUnitDecorators", s:magenta, s:none, s:none)  "added (Number)
"call Highlight("cssFontProp", s:light_blue, s:none, s:italic)   "added (StorageClass)
call Highlight("cssPositioningAttr", s:light_blue, s:none, s:none)   "added (Constant)
call Highlight("cssSelectorOp", s:white, s:none, s:none)   "added (Special)
call Highlight("cssPseudoClassId", s:white, s:none, s:none)   "added (PreProc)
call Highlight("cssAttrComma", s:white, s:none, s:none)   "added (Special)
call Highlight("cssTextAttr", s:light_blue, s:none, s:none)   "added (Constant)
call Highlight("cssNoise", s:white, s:none, s:none)   "added (Noise)
call Highlight("cssColor", s:purple, s:none, s:none)   "added (pro)
call Highlight("scssFunctionName", s:light_blue, s:none, s:none)   "added (Function)
call Highlight("scssVariableValue", s:light_blue, s:none, s:none)   "added (same)
" scssAttribute: minus sign, colon, multiply (*), issues determining inside nests 
call Highlight("scssAttribute", s:white, s:none, s:none)   "added (scssAttribute)
call Highlight("scssNestedProperty", s:light_blue, s:none, s:none) "cssProp
call Highlight("scssVariable", s:orange, s:none, s:italic)  "Identifier
call Highlight("scssGlobal", s:purple, s:none, s:none)  "Special
"call Highlight("scssNull", s:purple, s:none, s:none)  "Constant
"call Highlight("scssBoolean", s:magenta, s:none, s:none)  "Constant
"call Highlight("scssBooleanOp", s:magenta, s:none, s:none)  "Operator
"call Highlight("scssMixin", s:magenta, s:none, s:none)  "PreProc
"call Highlight("scssMixinName", s:light_green, s:none, s:none)  "Function
"call Highlight("scssContent", s:magenta, s:none, s:none)   "PreProc
"call Highlight("scssFunctionDefinition", s:magenta, s:none, s:none)  "PreProc
"call Highlight("scssFunctionName", s:light_green, s:none, s:none)  "Function
"call Highlight("scssReturn", s:magenta, s:none, s:none)    "Statement
"call Highlight("scssInclude", s:magenta, s:none, s:none)   "PreProc
"call Highlight("scssExtend", s:magenta, s:none, s:none)    "PreProc
"TODOcall Highlight("scssOptional",,)  "Special
"call Highlight("scssComment", s:grey, s:none, s:none)   "Comment
"TODOcall Highlight("scssStickyCommentChar",,)  "Special
call Highlight("scssSelectorChar", s:light_green, s:none, s:none)   "Special
call Highlight("scssSelectorName", s:light_green, s:none, s:none)   "Identifier
call Highlight("scssAmpersand", s:magenta, s:none, s:none)   "Character
" call Highlight("scssDebug",,)     "Debug
" call Highlight("scssWarn",,)      "Debug
" call Highlight("scssError",,)    "Debug
" call Highlight("scssDefault",,)   "Special
" call Highlight("scssIf",,,)        "Conditional
" call Highlight("scssElse",,)      "Conditional
" call Highlight("scssWhile",,)     "Repeat
" call Highlight("scssForKeyword",,)   "Repeat
" call Highlight("scssEachKeyword",,)   "Repeat
" call Highlight("scssInterpolationDelimiter",,)   "Delimiter
" call Highlight("scssImport",,)    "Include
" call Highlight("scssTodo",,)      "Todo
" call Highlight("scssAtRoot",,)    "Keyword
" call Highlight("scssMapParens",,)   "Delimiter
" call Highlight("scssSemicolon",,)   "Delimiter

" Markdown highlighting
call Highlight("mkdHeading", s:pale_green, s:none, s:none)
call Highlight("htmlH1", s:olive, s:none, s:none)
call Highlight("htmlH2", s:light_green, s:none, s:none)
call Highlight("htmlH3", s:light_blue, s:none, s:none)
call Highlight("htmlH4", s:light_sea_blue, s:none, s:none)
call Highlight("htmlH5", s:teal, s:none, s:none)
call Highlight("htmlH6", s:sea_blue, s:none, s:none)

call Highlight("mkdNonListItemBlock", s:white, s:none, s:none)
call Highlight("mkdItalic", s:pink, s:none, s:none)
call Highlight("htmlItalic", s:orange, s:none, s:italic)
call Highlight("mkdBold", s:pink, s:none, s:none)
call Highlight("htmlBold", s:orange, s:none, s:bold)

call Highlight("mkdBlockquote", s:orange, s:none, s:none)
call Highlight("mkdLink", s:yellow, s:none, s:none)
call Highlight("mkdURL", s:light_blue, s:none, s:underline)
call Highlight("mkdFootnotes", s:light_blue, s:none, s:underline)
call Highlight("mkdListItem", s:pale_green, s:none, s:none)

call Highlight("mkdLineBreak", s:none, s:light_charcoal, s:none)
